/*
NOTE THIS IS A BROKEN SOURCE CODE CONTAINING THE AUDIO ENGINE
FIX THIS IF YOU WANT AND DO A PULL REQUEST OR SOMETHING
LOVE ME 
*/
*
...
void audio_load(const char *audio){
	...
	csndPlaySound(0x8, SOUND_FORMAT_16BIT | SOUND_REPEAT, SAMPLERATE,
		buffer, buffer, size);
